...
#                     racial_issue == "Campus climate"
  ...
  make_wave_line_graph(mizzou_umbrella_daily_count, "Second US Wave (Mizzou umbrella)") +
...
```{r}
 ...
 make_third_wave_line_graph <- function() {
       ggplot() +
      geom_line(data = trump_not_immigration_daily_count, aes(x = start_date, y = n, color = "Trump not immigration"), size = 0.8) +
      geom_line(data = immigration_not_trump_daily_count, aes(x = start_date, y = n, color = "Immigration not Trump"), size = 0.8) +
      geom_line(data = trump_and_immigration_daily_count, aes(x = start_date, y = n, color = "Trump and immigration"), size = 0.8) +
...
```{r}
  ...
  make_canada_first_wave_graph <- function() {
       ggplot() +
      geom_line(data = quebec_tuition_daily_count, aes(x = start_date, y = n, color = "Tuition"), size = 0.8) +
      geom_line(data = quebec_police_violence_daily_count, aes(x = start_date, y = n, color = "Police Violence"), size = 0.8) +
      ...
      scale_color_manual(values = canada_first_wave_colors)
 }
...
```{r}
  ...
  canada_second_wave_colors <- c("Toronto Labor" = "coral4", "Quebec Labor" = "darkcyan", "Quebec Economy" = "black")
    ...
    make_canada_second_wave_graph <- function() {
       ggplot() +
      geom_line(data = toronto_labor_daily_count, aes(x = start_date, y = n, color = "Toronto Labor"), size = 0.8) +
      geom_line(data = quebec_labor_daily_count, aes(x = start_date, y = n, color = "Quebec Labor"), size = 0.8) +
      geom_line(data = quebec_economy_daily_count, aes(x = start_date, y = n, color = "Quebec Economy"), size = 0.8) +
      scale_x_date(expand = c(0, 0),date_breaks = "3 weeks", date_labels = "%b %d") +
      ...
      scale_color_manual(values = canada_second_wave_colors)
 }
